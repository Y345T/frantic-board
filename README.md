...
<!-- crier:ledger:start -->
```
2026-09-15  UPDATED   AUTO REVIEW #79: ready for human review (excellent 5/5) · All 12 acceptance bullets met. Package name exact: crm-cleanup. runx-cli 0.9.1 satisfies the 0.6.14 floor. PR #483 against runxhq/runx contains the skill package; raw x_yaml and skill_md are fetchable from the PR head...  frantic:event:75b3a993-4903-4e23-be80-f97cd60697fc
